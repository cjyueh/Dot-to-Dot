...
function clickDot() {
  ...
  //   $(this).next().next().toggleClass('glow');
  // });
  // $("#"+dotsArray[n]).on('click', dotGlow);
...
var lineHeightsArr = ["0", "0", "+=125px", "0", "+=80px", "0", "+=80", "0", "0", "+=50px", "0", "+=60px", "0", "+=60px", "0", "+=55px", "0", "+=55px", "0", "+=81px", "0", "+=50px", "0", "+=135px", "0", "+=80px", "0", "+=130px", "0", "+=20px", "0", "0", "+=70px", "0"];
